Shader "Hidden/BlendModes/SuperShape/UnifiedGrabMasked"
{
	Properties
	{
	...
	SubShader
	{
            ...
            fixed4 frag (v2f o) : SV_Target
            {
				...
				if (o.uv.x * o.uv.y != 0)
				{
					temp = temp * (1 - _Tint) + _Color * _Tint;
						...
						temp *= tex2D(_MainTex, textureCoordinate);
					#endif
		...
		Pass
		{
            ...
            #pragma fragment frag
			#pragma target 3.0
			#pragma multi_compile TEXTURE_COORDINATES_DOUBLE_UV TEXTURE_COORDINATES_UV TEXTURE_COORDINATES_SCREENSPACE
