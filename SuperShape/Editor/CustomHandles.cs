...
public class CustomHandles
{
	...
	public static int lastClickedManualID;
	...
	public static Vector3 DragHandle(int manualID, Vector3 position, float handleSize, Handles.CapFunction capFunc, Color colorSelected, out DragHandleResult result)
	{
